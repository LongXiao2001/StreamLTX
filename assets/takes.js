...
window.TAKES = [
  ...
  },
  {
    ...
    source: 'Uploaded first frame · no rundown · typed live',
    blurb:
      'A mascot render, uploaded as the first frame, driven through motion it was never posed for: wave, jump, spin, then walk to the tent at the back and lie down inside it. One cue rewrites the global prompt instead of the local one, and the room darkens around him.',
    cues: [
      { t: 16.5, cls: 'action', act: 'Stands still and raises his right hand in a friendly wave', line: '你好！欢迎来到扣扣空间，很高兴认识你！', gloss: 'Hello! Welcome to QQ space. Nice to meet you!' },
      { t: 20.2, cls: 'action', act: 'Holds his standing pose and delivers the next line', line: '今天又是认真工作的一天，回家啦。', gloss: "Another honest day's work done. Time to head home." },
      { t: 32.5, cls: 'action', act: 'Jumps up, then settles back to standing', line: '跳一跳，舒展筋骨。', gloss: 'A little jump to loosen up.' },
      { t: 45.2, cls: 'action', act: 'Spins once all the way around', line: '转圈圈。脑子转晕啦。', gloss: "Spinning around — now I'm dizzy." },
      { t: 51.5, cls: 'scene', act: 'Global prompt rewritten mid-stream: he sleeps in the tent, lights off, the room in darkness' },
      { t: 58.2, cls: 'prop', act: 'Walks over to the small tent behind him and lies down inside it' },
    ],
  },
];
